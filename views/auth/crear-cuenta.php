...
<form action="/crear-cuenta" class="formulario" method="POST">
    ...
    <div class="campo">
        ...
        <input type="email" id="email" name="email" placeholder="Tu email" autocomplete="off" value=<?php echo s($usuario->email); ?>>
    </div>
    <div class="campo">
        <label for="password">Password</label>
        <input type="password" id="password" name="password" placeholder="Tu password" value=<?php s($usuario->password); ?>>
    </div>
    <div class="boton-submit">
        <input type="submit" value="Crear Cuenta" class="boton centrado">
    </div>
